...
// 6. Print the length of the penguins array to the console.
      penguins.length
// 7. Write one more line of code to change the first penguin's canFly property 
  penguins.canfly[0] ="false"
    penguins.canfly
...
// 9.Write a for loop to iterate through every penguin in the array and print the
 // value of each penguin's name property to the console.
  for (var i=0 ;i<penguins.length ;i++){
    console.log(penguins[i]);
  }
// 10.Write a for loop to call the sayHello method of every penguin in the array!

// 11.Write a for loop to iterate through every penguin in the array, and add a new 
// property to each penguin called numberOfFeet with the value 2
for (var i=0 ;i<penguins.length ;i++){
    penguins.numberOfFeet="2"
    }

// 12.Write another for loop to iterate through every penguin in the array, and 
// for each penguin that can fly, print to the console a message containing the penguin's name
 // and " can fly!" -- for example, "Gunter can fly!" or "Ramón can fly!" (Don't do anything for 
 // the penguins that cannot fly.)
 for (var i=0 ;i<penguins.length ;i++){
